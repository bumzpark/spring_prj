...
public class MultiActionController extends AbstractController implements LastModified {
	...
	/**
	 * Constructor for <code>MultiActionController</code> that looks for handler
	 * methods in the present subclass.
	 */
	...
	/**
	 * Constructor for <code>BaseMultiActionController</code> that looks for
	 * handler methods in delegate, rather than a subclass of this class.
	 * 
	 * @param delegate
	 *            handler object. This does not need to implement any particular
	...
	protected void bind(HttpServletRequest request, Object command) throws Exception {
		logger.debug("Binding request parameters onto BaseMultiActionController command");
	...
	protected ServletRequestDataBinder createBinder(HttpServletRequest request, Object command) throws Exception {
		...
		// ServletRequestDataBinder(command, getCommandName(command));
		CustomServletRequestDataBinder binder = new CustomServletRequestDataBinder(command, getCommandName(command));
	...
	private ModelAndView handleException(HttpServletRequest request, HttpServletResponse response, Throwable ex) throws Exception {
		...
		if (handler != null) {
			...
			// If we get here, there was no custom handler or we couldn't invoke
			// it.
